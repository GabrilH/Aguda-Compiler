...
entry:
  %".3" = alloca i1
  store i1 %".1", i1* %".3"
  br i1 1, label %"cond_1_then", label %"cond_1_else"
cond_1_then:
  br label %"cond_1_end"
cond_1_else:
  br label %"cond_1_end"
cond_1_end:
  %".8" = phi  i32 [3, %"cond_1_then"], [4, %"cond_1_else"]
  br i1 1, label %"cond_2_then", label %"cond_2_else"
cond_2_then:
  br i1 0, label %"cond_3_then", label %"cond_3_else"
cond_2_else:
  br label %"cond_2_end"
cond_2_end:
  %".16" = phi  i32 [%".13", %"cond_3_end"], [7, %"cond_2_else"]
  %".17" = call i32 @"add"(i32 %".8", i32 %".16")
...
cond_3_else:
  br label %"cond_3_end"
cond_3_end:
  %".13" = phi  i32 [5, %"cond_3_then"], [6, %"cond_3_else"]
  br label %"cond_2_end"
}
