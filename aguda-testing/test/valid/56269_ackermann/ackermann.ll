...
cond_1_else:
  %".14" = load i32, i32* %".6"
  %".15" = icmp eq i32 %".14", 0
  br i1 %".15", label %"cond_2_then", label %"cond_2_else"
cond_1_end:
  %".31" = phi  i32 [%".12", %"cond_1_then"], [%".29", %"cond_2_end"]
  ret i32 %".31"
cond_2_then:
  %".17" = load i32, i32* %".4"
  %".18" = sub i32 %".17", 1
  %".19" = call i32 @"ack"(i32 %".18", i32 1)
  br label %"cond_2_end"
cond_2_else:
  %".21" = load i32, i32* %".4"
  %".22" = sub i32 %".21", 1
  ...
  %".24" = load i32, i32* %".6"
  %".25" = sub i32 %".24", 1
  %".26" = call i32 @"ack"(i32 %".23", i32 %".25")
  %".27" = call i32 @"ack"(i32 %".22", i32 %".26")
  br label %"cond_2_end"
cond_2_end:
  %".29" = phi  i32 [%".19", %"cond_2_then"], [%".27", %"cond_2_else"]
  br label %"cond_1_end"
}
