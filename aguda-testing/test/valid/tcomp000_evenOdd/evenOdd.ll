...
entry:
  ...
  %".5" = load i32, i32* %".3"
  %".6" = icmp eq i32 %".5", 0
  br i1 %".6", label %"bool_1_end", label %"bool_1_right"
bool_1_right:
  %".8" = load i32, i32* %".3"
  %".9" = sub i32 %".8", 1
  %".10" = call i1 @"odd"(i32 %".9")
  br label %"bool_1_end"
bool_1_end:
  %".12" = phi  i1 [%".6", %"entry"], [%".10", %"bool_1_right"]
  ret i1 %".12"
}
...
entry:
  ...
  %".5" = load i32, i32* %".3"
  %".6" = icmp ne i32 %".5", 0
  br i1 %".6", label %"bool_2_right", label %"bool_2_end"
bool_2_right:
  %".8" = load i32, i32* %".3"
  %".9" = sub i32 %".8", 1
  %".10" = call i1 @"even"(i32 %".9")
  br label %"bool_2_end"
bool_2_end:
  %".12" = phi  i1 [%".6", %"entry"], [%".10", %"bool_2_right"]
  ret i1 %".12"
}
