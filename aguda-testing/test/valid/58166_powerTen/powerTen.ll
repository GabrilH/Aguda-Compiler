...
cond_1_end:
  %".25" = phi  i1 [0, %"cond_1_then"], [%".23", %"cond_2_end"]
  %".26" = load i32, i32* %".5"
  ret i32 %".26"
cond_2_then:
  store i32 1, i32* %".5"
...
cond_2_else:
  %".17" = load i32, i32* %".3"
  %".18" = sub i32 %".17", 1
  %".19" = call i32 @"powerTen"(i32 %".18")
  %".20" = mul i32 10, %".19"
  store i32 %".20", i32* %".5"
  br label %"cond_2_end"
cond_2_end:
  %".23" = phi  i1 [0, %"cond_2_then"], [0, %"cond_2_else"]
  br label %"cond_1_end"
}
