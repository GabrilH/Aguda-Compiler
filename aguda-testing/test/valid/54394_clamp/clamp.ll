...
entry:
  ...
  %".9" = load i32, i32* %".6"
  %".10" = icmp sgt i32 %".8", %".9"
  br i1 %".10", label %"cond_1_then", label %"cond_1_else"
cond_1_then:
  %".12" = load i32, i32* %".6"
  br label %"cond_1_end"
cond_1_else:
  ...
  br label %"cond_1_end"
cond_1_end:
  %".16" = phi  i32 [%".12", %"cond_1_then"], [%".14", %"cond_1_else"]
  ret i32 %".16"
}
...
entry:
  ...
  %".9" = load i32, i32* %".6"
  %".10" = icmp slt i32 %".8", %".9"
  br i1 %".10", label %"cond_2_then", label %"cond_2_else"
cond_2_then:
  %".12" = load i32, i32* %".6"
  br label %"cond_2_end"
cond_2_else:
  ...
  br label %"cond_2_end"
cond_2_end:
  %".16" = phi  i32 [%".12", %"cond_2_then"], [%".14", %"cond_2_else"]
  ret i32 %".16"
}

define i32 @"clamp"(i32 %".1", i32 %".2", i32 %".3")
{
entry:
  %".5" = alloca i32
  store i32 %".1", i32* %".5"
...
entry:
  %".3" = alloca i1
  store i1 %".1", i1* %".3"
  %".5" = call i32 @"clamp"(i32 0, i32 7, i32 16)
