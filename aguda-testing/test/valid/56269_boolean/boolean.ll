...
cond_1_else:
  br label %"cond_1_end"
cond_1_end:
  %".8" = phi  i1 [1, %"cond_1_then"], [0, %"cond_1_else"]
  %".9" = getelementptr [5 x i8], [5 x i8]* @"true_str", i32 0, i32 0
  %".10" = getelementptr [6 x i8], [6 x i8]* @"false_str", i32 0, i32 0
  %".11" = select  i1 %".8", i8* %".9", i8* %".10"
