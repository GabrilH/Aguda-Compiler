...
cond_1_else:
  ...
  br label %"cond_1_end"
cond_1_end:
  %".13" = phi  i32 [%".9", %"cond_1_then"], [%".11", %"cond_1_else"]
  %".14" = alloca i32
  store i32 %".13", i32* %".14"
  %".16" = load i32, i32* %".14"
...
cond_2_else:
  %".20" = load i32, i32* %".14"
  %".21" = sdiv i32 %".20", 10
  %".22" = call i32 @"digits"(i32 %".21")
  %".23" = add i32 1, %".22"
  br label %"cond_2_end"
cond_2_end:
  %".25" = phi  i32 [1, %"cond_2_then"], [%".23", %"cond_2_else"]
  ret i32 %".25"
}
