...
while_1_cond:
  br i1 0, label %"while_1_body", label %"while_1_end"
while_1_body:
  %".7" = load i32, i32* %".3"
  %".8" = getelementptr [3 x i8], [3 x i8]* @"int_format", i32 0, i32 0
...
entry:
  %".3" = alloca i1
  store i1 %".1", i1* %".3"
  %".5" = call i1 @"countForever"(i32 10)
  %".6" = load i1, i1* %".3"
  %".7" = getelementptr [5 x i8], [5 x i8]* @"unit_str", i32 0, i32 0
