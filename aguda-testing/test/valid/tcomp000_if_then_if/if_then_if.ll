...
cond_1_then:
  br i1 0, label %"cond_2_then", label %"cond_2_else"
cond_1_else:
  br label %"cond_1_end"
cond_1_end:
  %".12" = phi  i1 [%".9", %"cond_2_end"], [0, %"cond_1_else"]
  %".13" = getelementptr [5 x i8], [5 x i8]* @"unit_str", i32 0, i32 0
...
cond_2_else:
  br label %"cond_2_end"
cond_2_end:
  %".9" = phi  i1 [0, %"cond_2_then"], [0, %"cond_2_else"]
  br label %"cond_1_end"
}
