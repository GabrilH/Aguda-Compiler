...
entry:
  ...
  %".5" = load i32, i32* %".3"
  %".6" = icmp eq i32 %".5", 4
  br i1 %".6", label %"cond_2_then", label %"cond_2_else"
cond_1_then:
  br label %"cond_1_end"
cond_1_else:
  br label %"cond_1_end"
cond_1_end:
  %".14" = phi  i1 [1, %"cond_1_then"], [0, %"cond_1_else"]
  ret i1 %".14"
cond_2_then:
  br label %"cond_2_end"
cond_2_else:
  br label %"cond_2_end"
cond_2_end:
  %".10" = phi  i1 [1, %"cond_2_then"], [0, %"cond_2_else"]
